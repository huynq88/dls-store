...
gulp.task('templates', function() {
    return gulp.src('twig/page/*.twig') // run the Twig template parser on all .html files in the "twig" directory
        .pipe(twig())
...
gulp.task('watch', function(){
    ...
    gulp.watch("twig/**/*.twig",['templates']);
    // Other watchers
});


// Default Task
gulp.task('default', ['sass', 'watch','serve','templates'], function () {
